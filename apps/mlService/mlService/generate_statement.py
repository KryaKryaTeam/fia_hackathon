...
- Використовуй лише ті статті Конституції, які були надані. Але старайся застосувати 
хочаб одну наведену статтю
...
- Наприкінці сформулюй чітке прохання до компетентного органу розглянути звернення, 
провести перевірку та вжити необхідних заходів.
